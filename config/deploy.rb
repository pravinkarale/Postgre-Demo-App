...
set :application, 'snapmint'
set :repo_url, 'git@github.com:sodel/snapmint.git'

# Default branch is :master
# ask :branch, `git rev-parse --abbrev-ref HEAD`.chomp

# Default deploy_to directory is /var/www/my_app
set :deploy_to, '/ebs/apps/snapmint'
set :repo_tree, "snapmint"
...
# Default value for :linked_files is []
set :linked_files, %w{config/database.yml config/newrelic.yml config/mongoid.yml}
